      ...
      <section className="mb-[3.8rem]">
        ...
        <div className="lg:flex">
          <div className="flex-1">
            <h1
              className="mb-[1.625rem] text-neutral-veryDarkBlue text-5xl font-bold
          ...
          <div className="flex-1 lg:ml-4">
            <p
              className="mb-[1.875rem] text-neutral-darkGrayIsHBlue text-[1.02rem] 
            ...
            <button
              className="w-[11.925rem] h-[3.125rem] bg-primary-softRed
